...
inline auto
PPreflection::dynamic_reference::cast_unsafe(
	PP::concepts::type auto t) const noexcept -> PP_GET_TYPE(t) &&
{
	return (PP_GET_TYPE(t) &&)(*reinterpret(PP::add_pointer(!t)));
}

inline auto
PPreflection::dynamic_reference::cast(PP::concepts::type auto t) const
	-> PP_GET_TYPE(t) &&
{
...
inline auto*
PPreflection::dynamic_reference::get_ptr(PP::concepts::type auto t) const
{
	return reinterpret(PP::add_pointer(t));
}

inline auto&
PPreflection::dynamic_reference::get_ref(PP::concepts::type auto t) const&
{
...
constexpr PPreflection::dynamic_reference::dynamic_reference(auto&& r) noexcept
	requires PP::concepts::different_except_cvref<decltype(r),
												  dynamic_reference>&& PP::
		concepts::different_except_cvref<decltype(r), dynamic_object>&& PP::
			concepts::different_except_cvref<decltype(r), dynamic_variable>
...
PPreflection::dynamic_reference::visit(PP::concepts::type auto t,
									   auto&&				   f) const
{
	if (is_lvalue)
	{
			...
			case PP::cv_qualifier::none:
				return PP_FORWARD(f)(
					cast_unsafe(detail::add_cv_except_to_array(
									PP::value<PP::cv_qualifier::none>, t) +
								PP::add_lvalue_tag));
			case PP::cv_qualifier::Const:
				return PP_FORWARD(f)(
					cast_unsafe(detail::add_cv_except_to_array(
									PP::value<PP::cv_qualifier::Const>, t) +
								PP::add_lvalue_tag));
			case PP::cv_qualifier::Volatile:
				return PP_FORWARD(f)(
					cast_unsafe(detail::add_cv_except_to_array(
									PP::value<PP::cv_qualifier::Volatile>, t) +
								PP::add_lvalue_tag));
			case PP::cv_qualifier::const_volatile:
				return PP_FORWARD(f)(cast_unsafe(
					detail::add_cv_except_to_array(
						PP::value<PP::cv_qualifier::const_volatile>, t) +
					PP::add_lvalue_tag));
		}
	} else
	{
		...
		{
			case PP::cv_qualifier::none:
				return PP_FORWARD(f)(cast_unsafe(detail::add_cv_except_to_array(
					PP::value<PP::cv_qualifier::none>, t)));
			case PP::cv_qualifier::Const:
				return PP_FORWARD(f)(cast_unsafe(detail::add_cv_except_to_array(
					PP::value<PP::cv_qualifier::Const>, t)));
...
inline decltype(auto)
PPreflection::dynamic_reference::visit_ptr(PP::concepts::type auto t,
										   auto&&				   f) const
{
	...
	{
		case PP::cv_qualifier::none:
			return PP_FORWARD(f)(cast_unsafe(PP::add_pointer(
...
constexpr void*
PPreflection::dynamic_reference::get_void_ptr() const
{
	if (is_function)
		return nullptr;
	else
