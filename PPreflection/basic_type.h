...
namespace detail
{
	...
	public:
		...
		constexpr simple_range<const cref_t<type>> get_direct_bases() const noexcept override;
		...
		constexpr simple_range<const cref_t<overloaded_member_function>> get_member_functions() const noexcept override;
	};
}
