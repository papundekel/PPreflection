...
constexpr auto
PPreflection::reference_type::make_reference(bool lvalue) const noexcept
{
	return dynamic_reference_type(remove_reference(), lvalue);
}
constexpr auto
PPreflection::reference_type::make_reference() const noexcept
{
	return make_reference(is_lvalue());
}
constexpr void
PPreflection::reference_type::print_name_prefix(
...
constexpr void
PPreflection::reference_type::print_name_suffix(
	PP::simple_ostream& out) const noexcept
{
	out.write(")");
...
constexpr bool
PPreflection::reference_type::operator==(
