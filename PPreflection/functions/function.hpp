...
constexpr void
PPreflection::function::print_name_basic(PP::simple_ostream& out) const noexcept
{
...
constexpr void
PPreflection::function::print_noexcept(PP::simple_ostream& out) const noexcept
{
	if (is_noexcept())
		out.write(" noexcept");
}
...
constexpr void
PPreflection::function::print_name_before_parent(
...
constexpr void
PPreflection::function::print_name_after_parent(
	PP::simple_ostream& out) const noexcept
{
