...
constexpr PPreflection::parent_descriptor_reference_strong::
	parent_descriptor_reference_strong(const class_type& d) noexcept
	: detail::parent_descriptor_reference_strong_base(PP::placeholder, d)
{}
constexpr PPreflection::parent_descriptor_reference_strong::
	parent_descriptor_reference_strong(const Namespace& d) noexcept
	: detail::parent_descriptor_reference_strong_base(PP::placeholder, d)
{}

constexpr const PPreflection::Namespace*
PPreflection::parent_descriptor_reference_strong::as_namespace() const noexcept
{
...
PPreflection::parent_descriptor_reference_strong::as_class() const noexcept
{
	return PP::visit(PP::overloaded(
						 [](const class_type& c)
						 {
...
PPreflection::parent_descriptor_reference_strong::get_parent(
	void*) const noexcept
{
	return PP::visit(
		[](const descriptor& d)
...
constexpr PPreflection::parent_descriptor_reference_strong::
operator parent_descriptor_reference() const noexcept
{
	return PP::visit(
		[](const auto& d)
		{
			return parent_descriptor_reference(d);
		},
		*this);
}
