...
template <> constexpr inline auto detail::reflect_metadata_generated<detail::name_wrap<namespace_t::global>> = std::string_view("global'");
template <> constexpr inline auto detail::reflect_metadata_generated<namespace_t::global> =
...
/*template <> constexpr inline auto detail::reflect_metadata_generated<detail::name_wrap<X>> = std::string_view("X");
template <> constexpr inline auto detail::reflect_metadata_generated<detail::id_wrap<X>> = std::size_t(0);
template <> constexpr inline auto detail::reflect_metadata_generated<X> = detail::basic_class_type<namespace_t::global, X,
	PP::type_pack<
	reflect_detail::X_f,
	overloaded_conversion_function_info<X, int>>,
	PP::type_pack<>>{};*/

template <> constexpr inline auto detail::reflect_metadata_generated<detail::constructor_wrap<X>>
...
template <> constexpr inline auto detail::reflect_metadata_generated<detail::name_wrap<reflect_detail::X_f>> = std::string_view("f");
template <> constexpr inline auto detail::reflect_metadata_generated<reflect_detail::X_f>
...
template <> constexpr inline auto detail::reflect_metadata_generated<PP::value_t<detail::overload_caster<reflect_detail::X_f, 0>>>
	= detail::basic_member_function<reflect_detail::X_f, detail::overload_caster<reflect_detail::X_f, 0>>{};
template <> constexpr inline auto detail::reflect_metadata_generated<PP::value_t<detail::overload_caster<reflect_detail::X_f, 1>>>
	= detail::basic_member_function<reflect_detail::X_f, detail::overload_caster<reflect_detail::X_f, 1>>{};

template <> constexpr inline auto detail::reflect_metadata_generated<detail::name_wrap<reflect_detail::global_double_>> = std::string_view("double_");
template <> constexpr inline auto detail::reflect_metadata_generated<reflect_detail::global_double_>
...
template <> constexpr inline auto detail::reflect_metadata_generated<PP::value_t<::overload_caster<const int&>(double_)>>
	= detail::basic_namespace_function<reflect_detail::global_double_, ::overload_caster<const int&>(double_)>{};
template <> constexpr inline auto detail::reflect_metadata_generated<PP::value_t<::overload_caster<const double&>(double_)>>
	= detail::basic_namespace_function<reflect_detail::global_double_, ::overload_caster<const double&>(double_)>{};

template <> constexpr inline auto detail::reflect_metadata_generated<overloaded_conversion_function_info<X, int>>
...
template <> constexpr inline auto detail::reflect_metadata_generated<PP::value_t<detail::overload_caster<overloaded_conversion_function_info<X, int>, 0>>>
	= detail::basic_conversion_function<detail::overload_caster<overloaded_conversion_function_info<X, int>, 0>, false>{};
template <> constexpr inline auto detail::reflect_metadata_generated<PP::value_t<detail::overload_caster<overloaded_conversion_function_info<X, int>, 1>>>
