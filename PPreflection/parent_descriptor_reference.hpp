...
constexpr PPreflection::parent_descriptor_reference::
	parent_descriptor_reference(const class_type& d) noexcept
	: detail::parent_descriptor_reference_base(PP::placeholder, d)
{}
constexpr PPreflection::parent_descriptor_reference::
	parent_descriptor_reference(const Namespace& d) noexcept
	: detail::parent_descriptor_reference_base(PP::placeholder, d)
{}
constexpr PPreflection::parent_descriptor_reference::
	parent_descriptor_reference() noexcept
	: detail::parent_descriptor_reference_base(PP::placeholder,
											   parent_descriptor_none_tag_t{})
{}

constexpr const PPreflection::descriptor*
PPreflection::parent_descriptor_reference::as_descriptor() const noexcept
{
...
PPreflection::parent_descriptor_reference::as_namespace() const noexcept
{
	return PP::visit(PP::overloaded(
						 [](const Namespace& n)
						 {
...
PPreflection::parent_descriptor_reference::as_class() const noexcept
{
	return PP::visit(PP::overloaded(
						 [](const class_type& c)
						 {
