...
std::unique_ptr<clang::ASTConsumer> PPreflector::action::CreateASTConsumer(clang::CompilerInstance& CI, clang::StringRef)
{
...
bool PPreflector::action::ParseArgs(const clang::CompilerInstance&, const std::vector<std::string>&)
{
	return true;
}
