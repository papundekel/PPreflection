...
void
PPreflector::constructor::print_name_header(llvm::raw_ostream& out) const
{
...
void
PPreflector::constructor::print_name_own(llvm::raw_ostream& out) const
{
...
void
PPreflector::constructor::print_name_foreign(llvm::raw_ostream& out) const
{
	out << printer_type_tuple(
		PPREFLECTOR_MEMBER_PRINT(print_parameter_types, *this));
}
...
void
PPreflector::constructor::print_metadata_object(llvm::raw_ostream& out) const
{
...
void
PPreflector::constructor::print_metadata_traits(llvm::raw_ostream& out) const
{
...
void
PPreflector::constructor::print_id(llvm::raw_ostream& out) const
{
