...
{
	out << PPREFLECTOR_MEMBER_PRINT(print_qualified_name, get_parent()) << "::" << PPREFLECTOR_MEMBER_PRINT(print_name, get_parent()) << "(" << PPREFLECTOR_MEMBER_PRINT(print_parameter_types, *this) << ")";
}

void PPreflector::constructor::print_name_own(llvm::raw_ostream& out) const
{
	out << printer_type_tuple(PPREFLECTOR_MEMBER_PRINT(print_parameter_types, *this));
}
...
{
	out << PPREFLECTOR_MEMBER_PRINT(print_name_foreign, get_parent()) << PPREFLECTOR_MEMBER_PRINT(print_parameter_types_leading_comma, *this);
}
