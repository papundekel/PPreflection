...
void
PPreflector::Enum::print_name_header(llvm::raw_ostream& out) const
{
	out << PPREFLECTOR_MEMBER_PRINT(print_qualified_name, *this);
}

void
PPreflector::Enum::print_name_own(llvm::raw_ostream& out) const
{
	out << "::" << PPREFLECTOR_MEMBER_PRINT(print_name_header, *this);
}

void
PPreflector::Enum::print_name_foreign(llvm::raw_ostream& out) const
{
	print_name_own(out);
}

void
PPreflector::Enum::print_metadata_members(llvm::raw_ostream& out) const
{
...
void
PPreflector::Enum::print_metadata_traits(llvm::raw_ostream& out) const
{
...
void
PPreflector::Enum::print_metadata_object(llvm::raw_ostream&) const
{
	// print nothing
}
