...
void PPreflector::non_global_namespace::print_unscoped_name(
	llvm::raw_ostream& out) const
{
	print_name(out);
}

void PPreflector::non_global_namespace::print_scoped_name_parent(
	llvm::raw_ostream& out) const
{
	get_parent().print_scoped_name_as_parent(out);
}

void PPreflector::non_global_namespace::print_scoped_name_as_parent(
	llvm::raw_ostream& out) const
{
...
void PPreflector::non_global_namespace::print_metadata_traits(
	llvm::raw_ostream& out) const
{
